...
impl Player {
    ...
    fn walk(&mut self) {
        self.stamina -= 1;
        self.steps += 1;
        println!("Stamina is now: {}", self.stamina);
    }
...
fn main() {
    ...
    while player.is_alive() && player.gold < 200 {
        ...
        if direction >= 1 && direction <= 4 {
            if direction == 1 {
                println!("You walked to North.");
            } else if direction == 2 {
                println!("You walked to South.");
            } else if direction == 3 {
                println!("You walked to West.");
            } else {
                println!("You walked to East.");
            }
            // let dir: Direction = match direction {
            //     1 => Direction::East,
            //     2 => Direction::West,
            //     3 => 
            // } 
